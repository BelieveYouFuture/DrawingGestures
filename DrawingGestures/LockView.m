...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    // 通知代理
    if ([self.delegate respondsToSelector:@selector(lockView:didFinishDrawWithPassword:)]) {
        [self.delegate lockView:self didFinishDrawWithPassword:password];
    }
}
